...
# 圖片收集
# 只取最相關前 2 筆資料的圖片
# 只讀 payload.images 與 metadata.images，不讀 original_metadata.images
# =========================
def collect_images_from_results(results: List[dict]) -> List[str]:
    images = []
...
def search(req: QueryRequest):
    ...
    try:
        ...
        images = collect_images_from_results(results)
